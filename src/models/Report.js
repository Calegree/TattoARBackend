...
const reportSchema = new mongoose.Schema({
  ...
  reports_id: { type: mongoose.Schema.Types.ObjectId, ref: 'User', required: true }, // Tatuador o diseño reportado
  type: { type: String, enum: ['tattooer', 'design','claim'], required: true },
  reason: { type: String, required: true },
  description: { type: String, required: true },
  state: { type: String, enum: ['pendiente', 'resuelto'], default: 'pendiente' },
